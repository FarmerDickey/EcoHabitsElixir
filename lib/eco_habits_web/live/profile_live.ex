    ...
    <div class="mx-auto max-w-2xl">
      ...
      <div class="mt-6 bg-white shadow rounded-lg p-6">
        ...
        <.simple_form
          ...
          phx-submit="save"
        >
          <.input field={@changeset[:name]} type="text" label="Nome" required />
          <.input field={@changeset[:bio]} type="textarea" label="Bio" placeholder="Conte um pouco sobre você e suas metas ambientais..." />
